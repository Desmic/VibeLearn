...
**Current review amendment — 14 September 2026:** Use a continuous 3D game-entry and play surface, third-person exploration, freely controlled camera and edge-to-edge mobile world. Safe-area HUD, intentional focus and readable forms remain essential; decorative 2D login scenes are superseded. Read [GAME-CAMERA-INPUT.md](GAME-CAMERA-INPUT.md).
