...
export const openingSpec={id:'bellweather.opening.v1',title:'BRING BACK THE WORDS',subtitle:'The First Words',finishLabel:'Help Zip →',waitForMotion:true,scenes:[
  {beat:0,kicker:'BELLWEATHER · THE NIGHT OF THE LANTERN PARADE',title:'Every adventure needs a friend.',body:'Zip made a lantern for the two of you. Nearly dropped it, too.',markers:[{entity:'zip',label:'ZIP',target:'zip',offset:[0,-8],hideWhenDone:true}],action:{target:'zip',label:'Give Zip a hand tap',patch:{animations:{zip:'wave'},transforms:{zip:{position:[-.2,0,3]},keeper:{position:[-1,0,3.5]},'our-lantern':{position:[-.2,1.2,3.5]},'keeper-arm-right':{rotation:[0,0,-65]}},timeline:{duration:1200,cues:[{at:1000,patch:{transforms:{'keeper-arm-right':{rotation:[0,0,0]}},animations:{zip:'yes'}}}]}}},success:{fact:'Zip: “Best team in Bellweather!”'}},
  {beat:1,kicker:'THE WARDEN HAS OTHER PLANS',title:'“No voices. No complaints.”',body:'He takes your friends’ speech engines and locks them in his tower.',markers:[{entity:'warden',label:'WARDEN',offset:[0,-8]}]},
  {beat:2,kicker:'ZIP PUSHES YOU CLEAR OF THE GATE',title:'Your friend saved you.',body:'Now Zip is trapped—and their voice is gone. A repair socket is within reach.',markers:[{entity:'zip',label:'ZIP',offset:[0,-8]}]}
]};